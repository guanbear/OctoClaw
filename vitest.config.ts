...
export default defineConfig({
  resolve: {
    alias: [
      ...
      { find: "@octoclaw/router/judge-schema", replacement: sourcePath("packages/octoclaw-router/src/semantic/judge-schema.ts") },
      { find: "@octoclaw/router/judge-prompt", replacement: sourcePath("packages/octoclaw-router/src/semantic/judge-prompt.ts") },
