    ...
    for record in records:
        ...
        case = {
            ...
            "outcome": {
                ...
                "resolved_model": str(record.get("resolved_model") or ""),
                "route_source": str(record.get("route_source") or ""),
                "fallback_taken": record.get("fallback_taken"),
                "queue_pressure_band": str(record.get("queue_pressure_band") or ""),
                "quota_pressure_band": str(record.get("quota_pressure_band") or ""),
                "validation_outcome": str(record.get("validation_outcome") or ""),
            },
