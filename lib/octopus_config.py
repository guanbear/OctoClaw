...
MODEL_INTEL_SOURCE_STATUS_FILE = f"{WORKSPACE}/tmp/octopus/model-intel-source-status.json"
MODEL_INTEL_MODELS_DEV_FILE = f"{WORKSPACE}/tmp/octopus/model-intel-models-dev.json"
MODEL_INTEL_MODELS_DEV_LAST_GOOD_FILE = f"{WORKSPACE}/tmp/octopus/model-intel-models-dev.last-good.json"
MODEL_INTEL_OPENROUTER_CATALOG_FILE = f"{WORKSPACE}/tmp/octopus/model-intel-openrouter-catalog.json"
MODEL_INTEL_OPENROUTER_CATALOG_LAST_GOOD_FILE = f"{WORKSPACE}/tmp/octopus/model-intel-openrouter-catalog.last-good.json"
MODEL_INTEL_OPENROUTER_RANKINGS_FILE = f"{WORKSPACE}/tmp/octopus/model-intel-openrouter-rankings.json"
MODEL_INTEL_OPENROUTER_RANKINGS_LAST_GOOD_FILE = f"{WORKSPACE}/tmp/octopus/model-intel-openrouter-rankings.last-good.json"
