...
- Tasks requiring web search, API calls, tool use, or external information retrieval → delegate + worker_research
- 查版本/查新特性/查文档/搜索信息 → delegate (these need external data)
