...
import {
  buildTsRuntimeDispatchPayload as buildTsRuntimeDispatchPayloadImpl,
  buildTsRuntimeSpawnPayload as buildTsRuntimeSpawnPayloadImpl,
} from "./src/runtime-payloads.ts";
...
function buildTsRuntimeDispatchPayload({
  ...
  return buildTsRuntimeDispatchPayloadImpl(
    { task, command, cwd, decision, metadata, timeoutSeconds, helperInvoker },
    {
...
function buildTsRuntimeSpawnPayload({
  ...
  return buildTsRuntimeSpawnPayloadImpl(
    { task, route, decision, metadata, helperInvoker, execute },
    {
      runtimeRouteDecision,
      normalizeLiveRoute,
      runtimeExecutionIds,
