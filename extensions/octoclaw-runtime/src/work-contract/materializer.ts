  ...
  return updateWorkContract(
    ...
    (contract) => {
      ...
      const telemetry: WorkContractTelemetry = {
        ...
        nativeTaskId: input.nativeTaskId ?? input.nativeBinding.nativeTaskId,
        nativeFlowId: input.nativeFlowId ?? input.nativeBinding.flowId,
        ...
        resultMaterialized: Boolean(input.nativeTaskId || input.nativeBinding.nativeTaskId),
