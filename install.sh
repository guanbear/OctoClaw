#!/usr/bin/env bash
# 八爪鱼 (OctoClaw) 安装脚本
# Runtime Slimming (2026-04-12):
# This install script only sets up the recommended path:
# - OpenClaw gateway
# - Node runtime extension
# - native task / runner pool
# - one-shot observe/reconcile/repair
#
# Legacy loop/daemon/cron/systemd paths have been removed.
# See docs/octoclaw-runtime-slimming-plan-2026-04-12.md
set -euo pipefail
...
# _openclaw_cron_store_id_by_name, _openclaw_cron_store_list,
# _openclaw_cron_api_list, _openclaw_cron_store_remove_by_name,
# _openclaw_cron_exists, _openclaw_cron_add, _openclaw_cron_id_by_name,
# _openclaw_cron_remove_by_name, _delete_cron_by_name,
# _disable_cron_by_name, _enable_cron_by_name

# REMOVED: legacy slimming (2026-04-12) — patrol-loop/runner-daemon/systemd/tmux functions deleted
# _PATROL_LOOP_PID_FILE, _RUNNER_DAEMON_PID_FILE, _SYSTEMD_* variables,
# _clear_stale_runtime_state, _systemd_available, _tmux_*,
# _disable_systemd_unit_if_present, _build_tmux_command_runner/patrol,
# _resolve_supervisor_mode, _render_systemd_unit, _systemd_restart_unit_safely,
# _install_systemd_units, _remove_systemd_units,
# _start_runner_service, _stop_runner_service,
# _start_patrol_service, _stop_patrol_service,
# _spawn_background_process, _start_patrol_loop, _stop_patrol_loop,
# _start_runner_daemon, _stop_runner_daemon
...
do_uninstall() {
    ...
    # REMOVED: legacy slimming (2026-04-12) — patrol/runner/cron/systemd cleanup removed
    echo "ℹ️  legacy patrol/runner/cron/systemd paths already removed in slimming"
...
do_disable() {
    ...
    # 停止巡逻
    echo "📡 legacy patrol/runner/cron/systemd paths already removed in slimming (2026-04-12)"
...
do_enable() {
    ...
    echo ""
    echo "✅ 八爪鱼已重新启用"
    echo "   使用 octoclawctl observe-once / reconcile-once / repair-once 进行按需诊断"
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo ""
}
