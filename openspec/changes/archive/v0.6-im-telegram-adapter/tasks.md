...
> **Shipped (verified):**
>
> - `extensions/octoclaw-runtime/src/im/telegram/telegram-adapter.ts`
> - `extensions/octoclaw-runtime/src/im/telegram/index.ts`
> - `extensions/octoclaw-runtime/src/im/telegram/telegram-adapter.test.ts`
> - Registration in `im/index.ts:134`.
>
> **Skipped (no environment):** Live Telegram smoke. Adapter remains
> "experimental" until at least one live deployment validates message send /
> reply / footer paths end-to-end.
