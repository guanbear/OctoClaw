...
> ## Archive note
>
> Archived 2026-05-15. Adapter shipped.
>
> **Shipped (verified):**
>
> - `extensions/octoclaw-runtime/src/im/discord/discord-adapter.ts`
> - `extensions/octoclaw-runtime/src/im/discord/index.ts`
> - `extensions/octoclaw-runtime/src/im/discord/discord-adapter.test.ts`
> - Registration in `im/index.ts:133`:
>   `adapterRegistry.push(new DiscordAdapter(buildDiscordAdapterConfig()))`.
>
> **Skipped (no environment):** Live Discord smoke. Adapter remains
> "experimental" until at least one live deployment validates the message
> send / reaction / footer paths end-to-end.
