...
> ## Archive note
>
> Archived 2026-05-15. 73/75 tasks complete; the two unchecked items are
> annotated `Skipped: no Slack test env available in CI` and require a live
> Slack workspace. Tracked instead under `v0.6-stability-hardening` Slack
> smoke phase.
>
> **Shipped:** Dispatch admission convergence, dispatch-honesty test suite,
> sealed dispatch supersede, structured terminal/retryable reject decisions,
> downgraded WorkContract / route-hint / workflow forbidden blocks, audit
> events.
>
> **Skipped (no environment):** Live Slack smoke (last 2 boxes).
