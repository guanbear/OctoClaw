> ## Archive note
>
> Archived 2026-05-15. All 33 tasks complete.
>
> **Shipped:** `octoclawctl router model-intel refresh` and
> `router model-config analyze` commands; selector + writer in
> `@octoclaw/policy/router-lite` (later migrated to `@octoclaw/router`).
>
> **Deferred:** None.
