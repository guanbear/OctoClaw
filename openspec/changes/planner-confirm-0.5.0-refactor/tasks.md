...
- Open follow-up: SR-P1 routing-time bucket selection and local runtime budget validation are in place; live replay evidence for fixed 30s soft escalation is still pending. 2026-05-04 real Slack attempts intentionally not accepted as evidence:
  ...
  SR-P2 latency remains above target because `before_prompt_build` and `sessions_spawn_intent_allowed` dominate accepted ACK time.
