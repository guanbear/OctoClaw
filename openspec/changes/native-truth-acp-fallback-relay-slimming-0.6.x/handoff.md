...
scope, the design defines architecture, BDD defines behavior, and tasks define
the safe order of edits.
...
evidence, and slim delivery relay into audit plus last-resort fallback.
...
Do not combine Phase 2 and Phase 3 in the same patch. They affect different
failure domains and must remain reviewable.
